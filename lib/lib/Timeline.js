...
// import './Timeline.css' // Remove when build for create-react-app
    ...
    value: function __onScroll__REACT_HOT_LOADER__() {
      ...
      if (this.state.visibleTimeStart !== visibleTimeStart || this.state.visibleTimeEnd !== visibleTimeStart + zoom) {
        if (this.props.disableZoom) {
          var timeStart = visibleTimeStart;
          var timeEnd = visibleTimeStart + zoom;
          var minTime = (0, _moment2.default)(this.props.visibleTimeStart);
          var maxTime = (0, _moment2.default)(this.props.visibleTimeEnd);
